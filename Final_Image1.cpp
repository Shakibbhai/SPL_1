...
int main()
{
    ...
    G=GREEN1();
    B=BLUE1();/*
    R={{100,100,100,100},{100,200,100,200},{10.1,20.1,30.1,40.1}};
    G={{122,122,122,122},{255,255,255,200},{25,35.5,45.5,55.5}};
    B={{9,8,7,6},{1,1,2,2},{3,4.4,5.5,6.6}};
    Red:
